  ...
  return <>
      ...
      <section className="relative overflow-hidden bg-primary/5 py-20 lg:py-[60px]">
        <div className="container mx-auto px-4">
          ...
          duration: 0.6
            ...
            <h1 className="mb-4 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{
      ...
      <section className="py-[40px]">
        <div className="container mx-auto px-[20px]">
          <h2 className="mb-8 text-center text-2xl font-bold md:text-3xl" style={{
          fontFamily: "var(--font-heading)"
        }}>
            Explore Topics
          </h2>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {CATEGORIES.map((cat, i) => <motion.div key={cat.slug} initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl rounded-2xl bg-primary/10 p-8 text-center md:p-12">
            <h2 className="mb-3 text-2xl font-bold" style={{
            fontFamily: "var(--font-heading)"
          }}>
